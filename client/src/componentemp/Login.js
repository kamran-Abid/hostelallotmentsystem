                ...
                <div className="container mt-5">
                    <div className="row signin-content">
                        <div className="signup-img col-md-6">
                            <figure>
                                <img src="images/login-admin.jpg" className="signup_img" alt="signup" />
                            </figure>
                            <NavLink to="/signupe" className="signin-image-link">Create an account</NavLink>
                        </div>
